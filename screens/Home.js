...
const FeaturedData = [
  {id: 1, title: 'Software Developer', company: 'Facebook', salary: '200', backgroundColor: '#5386e4', image: Fb, location: 'Accra, Ghana'},
  {id: 2, title: 'Web Developer', company: 'Facebook', salary: '200', backgroundColor: '#04284a', image: Google, location: 'Accra, Ghana'},
  {id: 3, title: 'QA Tester', company: 'Facebook', salary: '200', backgroundColor: 'red', image: Fb, location: 'Accra, Ghana'},
  {id: 4, title: 'Software Developer', company: 'Facebook', salary: '200', backgroundColor: 'red', image: Google, location: 'Accra, Ghana'},
  {id: 5, title: 'Software Developer', company: 'Facebook', salary: '200', backgroundColor: 'red', image: Fb, location: 'Accra, Ghana'},
  {id: 6, title: 'Software Developer', company: 'Facebook', salary: '200', backgroundColor: 'red', image: Google, location: 'Accra, Ghana'},
  {id: 7, title: 'Software Developer', company: 'Facebook', salary: '200', backgroundColor: 'red', image: Fb, location: 'Accra, Ghana'},
  {id: 8, title: 'Software Developer', company: 'Facebook', salary: '200', backgroundColor: 'red', image: Google, location: 'Accra, Ghana'},
]
        ...
        <SafeAreaView>
          <ScrollView>
            ...
            <View style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: 20, marginVertical: 20}}>
              <Text style={{fontWeight: 'bold', fontSize: 20}}>Featured Jobs</Text>
